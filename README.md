...
- **🆕 Built-in Port Scanner** - Scan IP ranges/CIDRs directly without external tools
- **🆕 AI-Powered Analysis** - Identify unknown applications and find default credentials
...
# 3. Scan IP ranges directly (no URL list needed!)
python Python/EyeWitness.py --scan 192.168.1.0/24
python Python/EyeWitness.py --scan 10.0.0.1-50 --scan-ports large
python Python/EyeWitness.py --scan 192.168.1.100 192.168.2.0/24 --scan-ports xlarge
...
### 🔍 IP/Network Scanning (No URL List Needed!)
```bash
# Activate virtual environment first
source eyewitness-venv/bin/activate  # Linux/macOS

# Scan a single IP
python Python/EyeWitness.py --scan 192.168.1.100

# Scan a CIDR range
python Python/EyeWitness.py --scan 192.168.1.0/24

# Scan IP range
python Python/EyeWitness.py --scan 10.0.0.1-50

# Scan with different port presets
python Python/EyeWitness.py --scan 192.168.1.0/24 --scan-ports small   # 80, 443
python Python/EyeWitness.py --scan 192.168.1.0/24 --scan-ports medium  # 80, 443, 8000, 8080, 8443
python Python/EyeWitness.py --scan 192.168.1.0/24 --scan-ports large   # 17 common ports
python Python/EyeWitness.py --scan 192.168.1.0/24 --scan-ports xlarge  # 70+ ports

# Scan with custom ports
python Python/EyeWitness.py --scan 192.168.1.100 --custom-ports 80,443,8080,9000

# Multiple targets at once
python Python/EyeWitness.py --scan 192.168.1.0/24 10.0.0.0/24 172.16.0.1-50

# Fast scan with more threads
python Python/EyeWitness.py --scan 192.168.1.0/24 --scan-threads 200 --scan-timeout 1.0
```
